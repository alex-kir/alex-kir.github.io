...
export class CMS {
    ...
    static {
        ...
        data.set('rules|hor|302|522', allowed);
        data.set('rules|hor|302|523', allowed);
        ...
        data.set('rules|hor|304|524', allowed);
        ...
        data.set('rules|hor|522|302', allowed);
        data.set('rules|hor|522|522', allowed);
        data.set('rules|hor|523|302', allowed);
        data.set('rules|hor|523|523', allowed);
        data.set('rules|hor|524|304', allowed);
        data.set('rules|hor|524|524', allowed);
        data.set('rules|hor|525|304', allowed);
        ...
        data.set('rules|ver|303|522', allowed);
        data.set('rules|ver|303|523', allowed);
        data.set('rules|ver|303|526', allowed);
        data.set('rules|ver|303|527', allowed);
        data.set('rules|ver|303|528', allowed);
        data.set('rules|ver|303|529', allowed);
        data.set('rules|ver|304|305', allowed);
        data.set('rules|ver|305|303', allowed);
        data.set('rules|ver|305|526', allowed);
        data.set('rules|ver|523|522', allowed);
        data.set('rules|ver|524|303', allowed);
        data.set('rules|ver|524|304', allowed);
        data.set('rules|ver|524|305', allowed);
        data.set('rules|ver|524|525', allowed);
        data.set('rules|ver|525|303', allowed);
        data.set('rules|ver|525|304', allowed);
        data.set('rules|ver|525|305', allowed);
        data.set('rules|ver|526|303', allowed);
        data.set('rules|ver|526|305', allowed);
        data.set('rules|ver|526|526', allowed);
        data.set('rules|ver|527|305', allowed);
        data.set('rules|ver|527|526', allowed);
        data.set('rules|ver|527|527', allowed);
        data.set('rules|ver|528|305', allowed);
        data.set('rules|ver|528|528', allowed);
        data.set('rules|ver|529|305', allowed);
